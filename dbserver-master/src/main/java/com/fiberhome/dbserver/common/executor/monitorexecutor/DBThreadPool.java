...
public class DBThreadPool extends ThreadPoolExecutor
{
     ...
     */
    DBThreadPool(int coreNum, int maxNum, long maxAlive, TimeUnit timeUnit,
                 BlockingQueue<Runnable> blockingQueue, ThreadFactory threadFactory,
                 RejectedExecutionHandler rejectedExecutionHandler)
    {
        super(coreNum, maxNum, maxAlive, timeUnit, blockingQueue, threadFactory, rejectedExecutionHandler);
    }
